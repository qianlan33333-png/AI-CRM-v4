...
- 生产版本 `3ab9946d45b99101d483e23d8a68c2492047b748`。渠道 57、58 已保存为启用的二维码配置，却没有 `channel_acquisition_assets` 记录；列表显示“后端未返回二维码地址”，没有可见申请入口。详情抽屉的申请按钮存在，但其三元表达式未被模板引擎渲染，按钮没有文字。
